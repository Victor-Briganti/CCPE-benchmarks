...
FILEPATH="./perf/"
CSVPATH="./perf/csv/"
DEFAULT="./perf/csv/default/pi_default1"
PDFPATH="./graphs/perf/"
APPROXIMATION = [
    # "default",
    "fast",
...
def plot_graph(default_results, results, title, approx, threshold=None):
    ...
    plt.title(f'PI Speedup {title}', fontsize=35)
    ...
    plt.tight_layout()
    if threshold == None:
        plt.savefig(PDFPATH + "pi_" + approx + '.pdf')
    else:
        plt.savefig(PDFPATH + "pi_" + approx + "_" + threshold + '.pdf')
